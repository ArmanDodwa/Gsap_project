  ...
  return (
    <div id="Art" className="w-full h-full relative bg-black pointer-events-none">
      <div className="container mx-auto h-full pt-20 ">
        <h2
          className="will-fade text-[35vh] font-extrabold leading-none text-transparent bg-clip-text bg-center bg-cover font-modern-negra text-center mb-10 "
          style={{
        ...
        <div className="masked-container w-full  opacity-0 md:px-0 px-5 space-y-5 absolute md:bottom-5 bottom-52 left-1/2 -translate-x-1/2">
